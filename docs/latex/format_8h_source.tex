...
\hypertarget{format_8h_source}{}\label{format_8h_source}\index{C:/Users/Admin/Programming/Projekt/JPOPRO/vcpkg\_installed/x64-\/windows/include/fmt/format.h@{C:/Users/Admin/Programming/Projekt/JPOPRO/vcpkg\_installed/x64-\/windows/include/fmt/format.h}}
...
\DoxyCodeLine{00110\ \textcolor{keyword}{template}\ <>\ \textcolor{keyword}{struct\ }iterator\_traits<fmt::appender>\ \{}
...
\DoxyCodeLine{00288\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Char>\ \textcolor{keyword}{using\ }\mbox{\hyperlink{structdetail_1_1std__string__view}{std\_string\_view}}\ =\ std::basic\_string\_view<Char>;}
...
\DoxyCodeLine{00318\ \}}
\DoxyCodeLine{00319\ }
\DoxyCodeLine{00320\ \textcolor{keyword}{class\ }uint128\_fallback\ \{}
...
\DoxyCodeLine{00325\ \ \ \textcolor{keyword}{constexpr}\ uint128\_fallback(uint64\_t\ hi,\ uint64\_t\ lo)\ :\ lo\_(lo),\ hi\_(hi)\ \{\}}
\DoxyCodeLine{00326\ \ \ \textcolor{keyword}{constexpr}\ uint128\_fallback(uint64\_t\ \mbox{\hyperlink{classdetail_1_1value}{value}}\ =\ 0)\ :\ lo\_(\mbox{\hyperlink{classdetail_1_1value}{value}}),\ hi\_(0)\ \{\}}
\DoxyCodeLine{00327\ }
...
\DoxyCodeLine{00334\ \ \ \}}
\DoxyCodeLine{00335\ }
\DoxyCodeLine{00336\ \ \ \textcolor{keyword}{friend}\ \textcolor{keyword}{constexpr}\ \textcolor{keyword}{auto}\ operator==(\textcolor{keyword}{const}\ uint128\_fallback\&\ lhs,}
\DoxyCodeLine{00337\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ uint128\_fallback\&\ rhs)\ -\/>\ \textcolor{keywordtype}{bool}\ \{}
...
\DoxyCodeLine{00349\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ uint128\_fallback\&\ rhs)}
\DoxyCodeLine{00350\ \ \ \ \ \ \ -\/>\ uint128\_fallback\ \{}
\DoxyCodeLine{00351\ \ \ \ \ \textcolor{keywordflow}{return}\ \{lhs.hi\_\ |\ rhs.hi\_,\ lhs.lo\_\ |\ rhs.lo\_\};}
\DoxyCodeLine{00352\ \ \ \}}
\DoxyCodeLine{00353\ \ \ \textcolor{keyword}{friend}\ \textcolor{keyword}{constexpr}\ \textcolor{keyword}{auto}\ operator\&(\textcolor{keyword}{const}\ uint128\_fallback\&\ lhs,}
\DoxyCodeLine{00354\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ uint128\_fallback\&\ rhs)}
\DoxyCodeLine{00355\ \ \ \ \ \ \ -\/>\ uint128\_fallback\ \{}
\DoxyCodeLine{00356\ \ \ \ \ \textcolor{keywordflow}{return}\ \{lhs.hi\_\ \&\ rhs.hi\_,\ lhs.lo\_\ \&\ rhs.lo\_\};}
\DoxyCodeLine{00357\ \ \ \}}
\DoxyCodeLine{00358\ \ \ \textcolor{keyword}{friend}\ \textcolor{keyword}{constexpr}\ \textcolor{keyword}{auto}\ operator\string~(\textcolor{keyword}{const}\ uint128\_fallback\&\ n)}
...
\DoxyCodeLine{00399\ \ \ \}}
\DoxyCodeLine{00400\ \ \ FMT\_CONSTEXPR\ \textcolor{keywordtype}{void}\ operator\&=(uint128\_fallback\ n)\ \{}
\DoxyCodeLine{00401\ \ \ \ \ lo\_\ \&=\ n.lo\_;}
\DoxyCodeLine{00402\ \ \ \ \ hi\_\ \&=\ n.hi\_;}
\DoxyCodeLine{00403\ \ \ \}}
\DoxyCodeLine{00404\ }
\DoxyCodeLine{00405\ \ \ FMT\_CONSTEXPR20\ \textcolor{keyword}{auto}\ operator+=(uint64\_t\ n)\ \textcolor{keyword}{noexcept}\ -\/>\ uint128\_fallback\&\ \{}
...
\DoxyCodeLine{00520\ \ \ \ \ \ \ \ \ \ \ FMT\_ENABLE\_IF(\mbox{\hyperlink{structdetail_1_1is__back__insert__iterator}{is\_back\_insert\_iterator<OutputIt>::value}}\&\&}
\DoxyCodeLine{00521\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ is\_contiguous<typename\ OutputIt::container>::value)>}
...
\DoxyCodeLine{00534\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ reserve(basic\_appender<T>\ it,\ \textcolor{keywordtype}{size\_t}\ n)\ -\/>\ basic\_appender<T>\ \{}
\DoxyCodeLine{00535\ \ \ \mbox{\hyperlink{classdetail_1_1buffer}{buffer<T>}}\&\ buf\ =\ get\_container(it);}
...
\DoxyCodeLine{00552\ \}}
\DoxyCodeLine{00553\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>\ \textcolor{keyword}{auto}\ to\_pointer(basic\_appender<T>\ it,\ \textcolor{keywordtype}{size\_t}\ n)\ -\/>\ T*\ \{}
\DoxyCodeLine{00554\ \ \ \mbox{\hyperlink{classdetail_1_1buffer}{buffer<T>}}\&\ buf\ =\ get\_container(it);}
...
\DoxyCodeLine{00563\ \ \ \ \ \ \ \ \ \ \ FMT\_ENABLE\_IF(\mbox{\hyperlink{structdetail_1_1is__back__insert__iterator}{is\_back\_insert\_iterator<OutputIt>::value}}\&\&}
\DoxyCodeLine{00564\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ is\_contiguous<typename\ OutputIt::container>::value)>}
...
\DoxyCodeLine{00579\ FMT\_CONSTEXPR\ \textcolor{keyword}{auto}\ fill\_n(OutputIt\ out,\ Size\ count,\ \textcolor{keyword}{const}\ T\&\ \mbox{\hyperlink{classdetail_1_1value}{value}})}
\DoxyCodeLine{00580\ \ \ \ \ -\/>\ OutputIt\ \{}
\DoxyCodeLine{00581\ \ \ \textcolor{keywordflow}{for}\ (Size\ i\ =\ 0;\ i\ <\ count;\ ++i)\ *out++\ =\ \mbox{\hyperlink{classdetail_1_1value}{value}};}
...
\DoxyCodeLine{00585\ FMT\_CONSTEXPR20\ \textcolor{keyword}{auto}\ fill\_n(T*\ out,\ Size\ count,\ \textcolor{keywordtype}{char}\ \mbox{\hyperlink{classdetail_1_1value}{value}})\ -\/>\ T*\ \{}
\DoxyCodeLine{00586\ \ \ \textcolor{keywordflow}{if}\ (is\_constant\_evaluated())\ \{}
\DoxyCodeLine{00587\ \ \ \ \ \textcolor{keywordflow}{return}\ fill\_n<T*,\ Size,\ T>(out,\ count,\ \mbox{\hyperlink{classdetail_1_1value}{value}});}
\DoxyCodeLine{00588\ \ \ \}}
\DoxyCodeLine{00589\ \ \ std::memset(out,\ \mbox{\hyperlink{classdetail_1_1value}{value}},\ to\_unsigned(count));}
...
\DoxyCodeLine{00658\ FMT\_CONSTEXPR\ \textcolor{keywordtype}{void}\ for\_each\_codepoint(string\_view\ s,\ F\ f)\ \{}
...
\DoxyCodeLine{00661\ \ \ \ \ \textcolor{keyword}{auto}\ \mbox{\hyperlink{namespacedetail_a7c070b2bf3d61e3d8b8013f6fb18d592acb5e100e5a9a3e7f6d1fd97512215282}{error}}\ =\ 0;}
\DoxyCodeLine{00662\ \ \ \ \ \textcolor{keyword}{auto}\ end\ =\ utf8\_decode(buf\_ptr,\ \&cp,\ \&\mbox{\hyperlink{namespacedetail_a7c070b2bf3d61e3d8b8013f6fb18d592acb5e100e5a9a3e7f6d1fd97512215282}{error}});}
\DoxyCodeLine{00663\ \ \ \ \ \textcolor{keywordtype}{bool}\ result\ =\ f(\mbox{\hyperlink{namespacedetail_a7c070b2bf3d61e3d8b8013f6fb18d592acb5e100e5a9a3e7f6d1fd97512215282}{error}}\ ?\ invalid\_code\_point\ :\ cp,}
\DoxyCodeLine{00664\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ string\_view(ptr,\ \mbox{\hyperlink{namespacedetail_a7c070b2bf3d61e3d8b8013f6fb18d592acb5e100e5a9a3e7f6d1fd97512215282}{error}}\ ?\ 1\ :\ to\_unsigned(end\ -\/\ buf\_ptr)));}
\DoxyCodeLine{00665\ \ \ \ \ \textcolor{keywordflow}{return}\ result\ ?\ (\mbox{\hyperlink{namespacedetail_a7c070b2bf3d61e3d8b8013f6fb18d592acb5e100e5a9a3e7f6d1fd97512215282}{error}}\ ?\ buf\_ptr\ +\ 1\ :\ end)\ :\ nullptr;}
\DoxyCodeLine{00666\ \ \ \};}
\DoxyCodeLine{00667\ \ \ \textcolor{keyword}{auto}\ p\ =\ s.data();}
...
\DoxyCodeLine{00669\ \ \ \textcolor{keywordflow}{if}\ (s.size()\ >=\ block\_size)\ \{}
\DoxyCodeLine{00670\ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{auto}\ end\ =\ p\ +\ s.size()\ -\/\ block\_size\ +\ 1;\ p\ <\ end;)\ \{}
\DoxyCodeLine{00671\ \ \ \ \ \ \ p\ =\ decode(p,\ p);}
\DoxyCodeLine{00672\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (!p)\ \textcolor{keywordflow}{return};}
\DoxyCodeLine{00673\ \ \ \ \ \}}
\DoxyCodeLine{00674\ \ \ \}}
\DoxyCodeLine{00675\ \ \ \textcolor{keywordflow}{if}\ (\textcolor{keyword}{auto}\ num\_chars\_left\ =\ s.data()\ +\ s.size()\ -\/\ p)\ \{}
...
\DoxyCodeLine{00689\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ compute\_width(basic\_string\_view<Char>\ s)\ -\/>\ \textcolor{keywordtype}{size\_t}\ \{}
...
\DoxyCodeLine{00694\ FMT\_CONSTEXPR\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ compute\_width(string\_view\ s)\ -\/>\ \textcolor{keywordtype}{size\_t}\ \{}
...
\DoxyCodeLine{00699\ \ \ \ \ FMT\_CONSTEXPR\ \textcolor{keyword}{auto}\ operator()(uint32\_t\ cp,\ string\_view)\ \textcolor{keyword}{const}\ -\/>\ \textcolor{keywordtype}{bool}\ \{}
...
\DoxyCodeLine{00729\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ code\_point\_index(basic\_string\_view<Char>\ s,\ \textcolor{keywordtype}{size\_t}\ n)\ -\/>\ \textcolor{keywordtype}{size\_t}\ \{}
...
\DoxyCodeLine{00735\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ code\_point\_index(string\_view\ s,\ \textcolor{keywordtype}{size\_t}\ n)\ -\/>\ \textcolor{keywordtype}{size\_t}\ \{}
...
\DoxyCodeLine{00738\ \ \ for\_each\_codepoint(s,\ [begin,\ \&n,\ \&result](uint32\_t,\ string\_view\ sv)\ \{}
...
\DoxyCodeLine{00849\ \ \ \ \ detail::abort\_fuzzing\_if(\mbox{\hyperlink{classdetail_1_1buffer_a8685285932360c284d19003fc4ba3edc}{size}}\ >\ 5000);}
\DoxyCodeLine{00850\ \ \ \ \ \textcolor{keyword}{auto}\&\ self\ =\ \textcolor{keyword}{static\_cast<}basic\_memory\_buffer\&\textcolor{keyword}{>}(buf);}
...
\DoxyCodeLine{00878\ \ \ \ \ \ \ :\ \mbox{\hyperlink{namespacedetail}{detail}}::buffer<T>(grow),\ alloc\_(alloc)\ \{}
...
\DoxyCodeLine{00881\ \ \ \}}
\DoxyCodeLine{00882\ \ \ FMT\_CONSTEXPR20\ \string~basic\_memory\_buffer()\ \{\ deallocate();\ \}}
\DoxyCodeLine{00883\ }
\DoxyCodeLine{00884\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00885\ \ \ \textcolor{comment}{//\ Move\ data\ from\ other\ to\ this\ buffer.}}
\DoxyCodeLine{00886\ \ \ FMT\_CONSTEXPR20\ \textcolor{keywordtype}{void}\ move(basic\_memory\_buffer\&\ other)\ \{}
...
\DoxyCodeLine{00906\ \ \ FMT\_CONSTEXPR20\ \mbox{\hyperlink{classbasic__memory__buffer_ade18cff12fc914085665a07af2e8fb7b}{basic\_memory\_buffer}}(basic\_memory\_buffer\&\&\ other)\ noexcept}
\DoxyCodeLine{00907\ \ \ \ \ \ \ :\ \mbox{\hyperlink{classdetail_1_1buffer}{detail::buffer<T>}}(grow)\ \{}
\DoxyCodeLine{00908\ \ \ \ \ move(other);}
\DoxyCodeLine{00909\ \ \ \}}
\DoxyCodeLine{00910\ }
\DoxyCodeLine{00912\ \ \ \textcolor{keyword}{auto}\ \mbox{\hyperlink{classbasic__memory__buffer_a20c8cea076154a579ab0a04afb6c1f84}{operator=}}(basic\_memory\_buffer\&\&\ other)\ \textcolor{keyword}{noexcept}\ -\/>\ basic\_memory\_buffer\&\ \{}
...
\DoxyCodeLine{00934\ \};}
\DoxyCodeLine{00935\ }
\DoxyCodeLine{00936\ \textcolor{keyword}{using\ }memory\_buffer\ =\ \mbox{\hyperlink{classbasic__memory__buffer}{basic\_memory\_buffer<char>}};}
\DoxyCodeLine{00937\ }
...
\DoxyCodeLine{00944\ FMT\_API\ \textcolor{keyword}{auto}\ write\_console(\textcolor{keywordtype}{int}\ fd,\ string\_view\ text)\ -\/>\ bool;}
\DoxyCodeLine{00945\ FMT\_API\ \textcolor{keywordtype}{void}\ print(std::FILE*,\ string\_view);}
...
\DoxyCodeLine{00990\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ OutputIt,\ \textcolor{keyword}{typename}\ Char>\ \textcolor{keyword}{class\ }generic\_context\ \{}
...
\DoxyCodeLine{00999\ \ \ \textcolor{keyword}{using\ }parse\_context\_type\ =\ \mbox{\hyperlink{classbasic__format__parse__context}{basic\_format\_parse\_context<Char>}};}
\DoxyCodeLine{01000\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>\ \textcolor{keyword}{using\ }formatter\_type\ =\ \mbox{\hyperlink{structformatter}{formatter<T,\ Char>}};}
\DoxyCodeLine{01001\ }
\DoxyCodeLine{01002\ \ \ \textcolor{keyword}{constexpr}\ generic\_context(OutputIt\ out,}
...
\DoxyCodeLine{01006\ \ \ generic\_context(generic\_context\&\&)\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{01007\ \ \ generic\_context(\textcolor{keyword}{const}\ generic\_context\&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{01008\ \ \ \textcolor{keywordtype}{void}\ operator=(\textcolor{keyword}{const}\ generic\_context\&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{01009\ }
...
\DoxyCodeLine{01030\ \};}
\DoxyCodeLine{01031\ }
\DoxyCodeLine{01032\ \textcolor{keyword}{class\ }loc\_value\ \{}
...
\DoxyCodeLine{01038\ \ \ loc\_value(T\ value)\ :\ value\_(detail::make\_arg<format\_context>(value))\ \{\}}
\DoxyCodeLine{01039\ }
...
\DoxyCodeLine{01041\ \ \ loc\_value(T)\ \{\}}
\DoxyCodeLine{01042\ }
...
\DoxyCodeLine{01050\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Locale>\ \textcolor{keyword}{class\ }format\_facet\ :\ \textcolor{keyword}{public}\ Locale::facet\ \{}
...
\DoxyCodeLine{01057\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keyword}{auto}\ do\_put(appender\ out,\ \mbox{\hyperlink{classloc__value}{loc\_value}}\ val,}
...
\DoxyCodeLine{01062\ }
\DoxyCodeLine{01063\ \ \ \textcolor{keyword}{explicit}\ format\_facet(Locale\&\ loc);}
\DoxyCodeLine{01064\ \ \ \textcolor{keyword}{explicit}\ format\_facet(string\_view\ sep\ =\ \textcolor{stringliteral}{"{}"{}},}
...
\DoxyCodeLine{01070\ }
\DoxyCodeLine{01071\ \ \ \textcolor{keyword}{auto}\ put(appender\ out,\ \mbox{\hyperlink{classloc__value}{loc\_value}}\ val,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{structformat__specs}{format\_specs}}\&\ specs)\ \textcolor{keyword}{const}}
...
\DoxyCodeLine{01116\ \textcolor{keyword}{constexpr}\ \textcolor{keyword}{auto}\ digits2(\textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{classdetail_1_1value}{value}})\ -\/>\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ \{}
...
\DoxyCodeLine{01254\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ thousands\_sep(\mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}}\ loc)\ -\/>\ \mbox{\hyperlink{structdetail_1_1thousands__sep__result}{thousands\_sep\_result<wchar\_t>}}\ \{}
...
\DoxyCodeLine{01259\ FMT\_API\ \textcolor{keyword}{auto}\ decimal\_point\_impl(\mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}}\ loc)\ -\/>\ Char;}
\DoxyCodeLine{01260\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Char>\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ decimal\_point(\mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}}\ loc)\ -\/>\ Char\ \{}
\DoxyCodeLine{01261\ \ \ \textcolor{keywordflow}{return}\ Char(decimal\_point\_impl<char>(loc));}
\DoxyCodeLine{01262\ \}}
\DoxyCodeLine{01263\ \textcolor{keyword}{template}\ <>\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ decimal\_point(\mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}}\ loc)\ -\/>\ \textcolor{keywordtype}{wchar\_t}\ \{}
...
\DoxyCodeLine{01313\ \ \ copy2(out,\ digits2(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(\mbox{\hyperlink{classdetail_1_1value}{value}})));}
...
\DoxyCodeLine{01319\ FMT\_CONSTEXPR\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ format\_decimal(Iterator\ out,\ UInt\ \mbox{\hyperlink{classdetail_1_1value}{value}},\ \textcolor{keywordtype}{int}\ size)}
...
\DoxyCodeLine{01322\ \ \ Char\ \mbox{\hyperlink{classdetail_1_1buffer}{buffer}}[digits10<UInt>()\ +\ 1]\ =\ \{\};}
\DoxyCodeLine{01323\ \ \ \textcolor{keyword}{auto}\ end\ =\ format\_decimal(\mbox{\hyperlink{classdetail_1_1buffer}{buffer}},\ \mbox{\hyperlink{classdetail_1_1value}{value}},\ size).end;}
\DoxyCodeLine{01324\ \ \ \textcolor{keywordflow}{return}\ \{out,\ detail::copy\_noinline<Char>(\mbox{\hyperlink{classdetail_1_1buffer}{buffer}},\ end,\ out)\};}
\DoxyCodeLine{01325\ \}}
\DoxyCodeLine{01326\ }
...
\DoxyCodeLine{01328\ FMT\_CONSTEXPR\ \textcolor{keyword}{auto}\ format\_uint(Char*\ \mbox{\hyperlink{classdetail_1_1buffer}{buffer}},\ UInt\ \mbox{\hyperlink{classdetail_1_1value}{value}},\ \textcolor{keywordtype}{int}\ num\_digits,}
...
\DoxyCodeLine{01342\ FMT\_CONSTEXPR\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ format\_uint(It\ out,\ UInt\ \mbox{\hyperlink{classdetail_1_1value}{value}},\ \textcolor{keywordtype}{int}\ num\_digits,}
...
\DoxyCodeLine{01345\ \ \ \ \ format\_uint<BASE\_BITS>(ptr,\ \mbox{\hyperlink{classdetail_1_1value}{value}},\ num\_digits,\ upper);}
...
\DoxyCodeLine{01349\ \ \ \textcolor{keywordtype}{char}\ \mbox{\hyperlink{classdetail_1_1buffer}{buffer}}[num\_bits<UInt>()\ /\ BASE\_BITS\ +\ 1]\ =\ \{\};}
\DoxyCodeLine{01350\ \ \ format\_uint<BASE\_BITS>(\mbox{\hyperlink{classdetail_1_1buffer}{buffer}},\ \mbox{\hyperlink{classdetail_1_1value}{value}},\ num\_digits,\ upper);}
\DoxyCodeLine{01351\ \ \ \textcolor{keywordflow}{return}\ detail::copy\_noinline<Char>(\mbox{\hyperlink{classdetail_1_1buffer}{buffer}},\ \mbox{\hyperlink{classdetail_1_1buffer}{buffer}}\ +\ num\_digits,\ out);}
\DoxyCodeLine{01352\ \}}
\DoxyCodeLine{01353\ }
\DoxyCodeLine{01354\ \textcolor{comment}{//\ A\ converter\ from\ UTF-\/8\ to\ UTF-\/16.}}
\DoxyCodeLine{01355\ \textcolor{keyword}{class\ }utf8\_to\_utf16\ \{}
...
\DoxyCodeLine{01360\ \ \ FMT\_API\ \textcolor{keyword}{explicit}\ utf8\_to\_utf16(string\_view\ s);}
...
\DoxyCodeLine{01362\ \ \ \textcolor{keyword}{auto}\ size()\ \textcolor{keyword}{const}\ -\/>\ \textcolor{keywordtype}{size\_t}\ \{\ \textcolor{keywordflow}{return}\ buffer\_.size()\ -\/\ 1;\ \}}
...
\DoxyCodeLine{01370\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ WChar,\ \textcolor{keyword}{typename}\ Buffer\ =\ memory\_buffer>\ \textcolor{keyword}{class\ }to\_utf8\ \{}
\DoxyCodeLine{01371\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{01372\ \ \ Buffer\ buffer\_;}
\DoxyCodeLine{01373\ }
\DoxyCodeLine{01374\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{01375\ \ \ to\_utf8()\ \{\}}
\DoxyCodeLine{01376\ \ \ \textcolor{keyword}{explicit}\ to\_utf8(\mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<WChar>}}\ s,}
...
\DoxyCodeLine{01383\ \ \ \}}
\DoxyCodeLine{01384\ \ \ \textcolor{keyword}{operator}\ string\_view()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ string\_view(\&buffer\_[0],\ size());\ \}}
...
\DoxyCodeLine{01409\ \ \ \ \ \ \ \ \ \ \ buf.append(string\_view(\textcolor{stringliteral}{"{}\(\backslash\)xEF\(\backslash\)xBF\(\backslash\)xBD"{}}));}
...
\DoxyCodeLine{01533\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ is\_float128<T>\mbox{\hyperlink{classdetail_1_1value}{::value}}>>\ \{}
...
\DoxyCodeLine{01604\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ F>\ \textcolor{keyword}{struct\ }basic\_fp\ \{}
...
\DoxyCodeLine{01610\ }
\DoxyCodeLine{01611\ \ \ \textcolor{keyword}{constexpr}\ basic\_fp()\ :\ f(0),\ e(0)\ \{\}}
\DoxyCodeLine{01612\ \ \ \textcolor{keyword}{constexpr}\ basic\_fp(uint64\_t\ f\_val,\ \textcolor{keywordtype}{int}\ e\_val)\ :\ f(f\_val),\ e(e\_val)\ \{\}}
\DoxyCodeLine{01613\ }
\DoxyCodeLine{01614\ \ \ \textcolor{comment}{//\ Constructs\ fp\ from\ an\ IEEE754\ floating-\/point\ number.}}
\DoxyCodeLine{01615\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Float>\ FMT\_CONSTEXPR\ basic\_fp(Float\ n)\ \{\ assign(n);\ \}}
\DoxyCodeLine{01616\ }
...
\DoxyCodeLine{01648\ \};}
\DoxyCodeLine{01649\ }
\DoxyCodeLine{01650\ \textcolor{keyword}{using\ }fp\ =\ \mbox{\hyperlink{structdetail_1_1basic__fp}{basic\_fp<unsigned\ long\ long>}};}
\DoxyCodeLine{01651\ }
...
\DoxyCodeLine{01697\ \textcolor{keyword}{constexpr}\ \textcolor{keyword}{auto}\ convert\_float(T\ \mbox{\hyperlink{classdetail_1_1value}{value}})\ -\/>\ convert\_float\_result<T>\ \{}
\DoxyCodeLine{01698\ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}convert\_float\_result<T>\textcolor{keyword}{>}(\mbox{\hyperlink{classdetail_1_1value}{value}});}
\DoxyCodeLine{01699\ \}}
\DoxyCodeLine{01700\ }
\DoxyCodeLine{01701\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Char,\ \textcolor{keyword}{typename}\ OutputIt>}
\DoxyCodeLine{01702\ FMT\_NOINLINE\ FMT\_CONSTEXPR\ \textcolor{keyword}{auto}\ fill(OutputIt\ it,\ \textcolor{keywordtype}{size\_t}\ n,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{structdetail_1_1fill__t}{fill\_t}}\&\ fill)}
...
\DoxyCodeLine{01717\ FMT\_CONSTEXPR\ \textcolor{keyword}{auto}\ write\_padded(OutputIt\ out,\ \textcolor{keyword}{const}\ format\_specs\&\ specs,}
...
\DoxyCodeLine{01736\ \textcolor{keyword}{constexpr}\ \textcolor{keyword}{auto}\ write\_padded(OutputIt\ out,\ \textcolor{keyword}{const}\ format\_specs\&\ specs,}
...
\DoxyCodeLine{01742\ FMT\_CONSTEXPR\ \textcolor{keyword}{auto}\ write\_bytes(OutputIt\ out,\ string\_view\ bytes,}
\DoxyCodeLine{01743\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ format\_specs\&\ specs\ =\ \{\})\ -\/>\ OutputIt\ \{}
\DoxyCodeLine{01744\ \ \ \textcolor{keywordflow}{return}\ write\_padded<Char,\ align>(}
\DoxyCodeLine{01745\ \ \ \ \ \ \ out,\ specs,\ bytes.\mbox{\hyperlink{classbasic__string__view_a216bbe1b012b590698d7bb4e96d1af3f}{size}}(),\ [bytes](reserve\_iterator<OutputIt>\ it)\ \{}
...
\DoxyCodeLine{01752\ \textcolor{keyword}{auto}\ write\_ptr(OutputIt\ out,\ UIntPtr\ \mbox{\hyperlink{classdetail_1_1value}{value}},\ \textcolor{keyword}{const}\ format\_specs*\ specs)}
\DoxyCodeLine{01753\ \ \ \ \ -\/>\ OutputIt\ \{}
\DoxyCodeLine{01754\ \ \ \textcolor{keywordtype}{int}\ num\_digits\ =\ count\_digits<4>(\mbox{\hyperlink{classdetail_1_1value}{value}});}
...
\DoxyCodeLine{01759\ \ \ \ \ \textcolor{keywordflow}{return}\ format\_uint<4,\ Char>(it,\ \mbox{\hyperlink{classdetail_1_1value}{value}},\ num\_digits);}
\DoxyCodeLine{01760\ \ \ \};}
...
\DoxyCodeLine{01794\ \ \ for\_each\_codepoint(string\_view(begin,\ to\_unsigned(end\ -\/\ begin)),}
\DoxyCodeLine{01795\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ [\&](uint32\_t\ cp,\ string\_view\ sv)\ \{}
...
\DoxyCodeLine{01840\ \textcolor{keyword}{auto}\ write\_escaped\_cp(OutputIt\ out,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{structdetail_1_1find__escape__result}{find\_escape\_result<Char>}}\&\ \mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}})}
\DoxyCodeLine{01841\ \ \ \ \ -\/>\ OutputIt\ \{}
\DoxyCodeLine{01842\ \ \ \textcolor{keyword}{auto}\ c\ =\ \textcolor{keyword}{static\_cast<}Char\textcolor{keyword}{>}(\mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}}.cp);}
\DoxyCodeLine{01843\ \ \ \textcolor{keywordflow}{switch}\ (\mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}}.cp)\ \{}
...
\DoxyCodeLine{01864\ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}}.cp\ <\ 0x100)\ \textcolor{keywordflow}{return}\ write\_codepoint<2,\ Char>(out,\ \textcolor{charliteral}{'x'},\ \mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}}.cp);}
\DoxyCodeLine{01865\ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}}.cp\ <\ 0x10000)}
\DoxyCodeLine{01866\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ write\_codepoint<4,\ Char>(out,\ \textcolor{charliteral}{'u'},\ \mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}}.cp);}
\DoxyCodeLine{01867\ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}}.cp\ <\ 0x110000)}
\DoxyCodeLine{01868\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ write\_codepoint<8,\ Char>(out,\ \textcolor{charliteral}{'U'},\ \mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}}.cp);}
\DoxyCodeLine{01869\ \ \ \ \ \textcolor{keywordflow}{for}\ (Char\ escape\_char\ :\ basic\_string\_view<Char>(}
\DoxyCodeLine{01870\ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}}.begin,\ to\_unsigned(\mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}}.end\ -\/\ \mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}}.begin)))\ \{}
...
\DoxyCodeLine{01881\ \textcolor{keyword}{auto}\ write\_escaped\_string(OutputIt\ out,\ basic\_string\_view<Char>\ str)}
...
\DoxyCodeLine{01886\ \ \ \ \ \textcolor{keyword}{auto}\ \mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}}\ =\ find\_escape(begin,\ end);}
\DoxyCodeLine{01887\ \ \ \ \ out\ =\ copy<Char>(begin,\ \mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}}.begin,\ out);}
\DoxyCodeLine{01888\ \ \ \ \ begin\ =\ \mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}}.end;}
\DoxyCodeLine{01889\ \ \ \ \ \textcolor{keywordflow}{if}\ (!begin)\ \textcolor{keywordflow}{break};}
\DoxyCodeLine{01890\ \ \ \ \ out\ =\ write\_escaped\_cp<OutputIt,\ Char>(out,\ \mbox{\hyperlink{namespacedetail_af2a9ce4740e0b45d33129e2c8e53a0a8}{escape}});}
...
\DoxyCodeLine{01913\ FMT\_CONSTEXPR\ \textcolor{keyword}{auto}\ write\_char(OutputIt\ out,\ Char\ \mbox{\hyperlink{classdetail_1_1value}{value}},}
\DoxyCodeLine{01914\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ format\_specs\&\ specs)\ -\/>\ OutputIt\ \{}
...
\DoxyCodeLine{01917\ \ \ \ \ \textcolor{keywordflow}{if}\ (is\_debug)\ \textcolor{keywordflow}{return}\ write\_escaped\_char(it,\ \mbox{\hyperlink{classdetail_1_1value}{value}});}
...
\DoxyCodeLine{01923\ FMT\_CONSTEXPR\ \textcolor{keyword}{auto}\ write(OutputIt\ out,\ Char\ \mbox{\hyperlink{classdetail_1_1value}{value}},\ \textcolor{keyword}{const}\ format\_specs\&\ specs,}
...
\DoxyCodeLine{01929\ \ \ \ \ \ \ \ \ \ \ \ \ \ ?\ write\_char<Char>(out,\ \mbox{\hyperlink{classdetail_1_1value}{value}},\ specs)}
\DoxyCodeLine{01930\ \ \ \ \ \ \ \ \ \ \ \ \ \ :\ write<Char>(out,\ static\_cast<unsigned\_type>(\mbox{\hyperlink{classdetail_1_1value}{value}}),\ specs,\ loc);}
\DoxyCodeLine{01931\ \}}
\DoxyCodeLine{01932\ }
...
\DoxyCodeLine{01935\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Char>\ \textcolor{keyword}{struct\ }write\_int\_data\ \{}
\DoxyCodeLine{01936\ \ \ \textcolor{keywordtype}{size\_t}\ size;}
\DoxyCodeLine{01937\ \ \ \textcolor{keywordtype}{size\_t}\ padding;}
\DoxyCodeLine{01938\ }
\DoxyCodeLine{01939\ \ \ FMT\_CONSTEXPR\ write\_int\_data(\textcolor{keywordtype}{int}\ num\_digits,\ \textcolor{keywordtype}{unsigned}\ prefix,}
...
\DoxyCodeLine{01981\ \}}
\DoxyCodeLine{01982\ }
\DoxyCodeLine{01983\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Char>\ \textcolor{keyword}{class\ }digit\_grouping\ \{}
...
\DoxyCodeLine{02005\ \ \ \textcolor{keyword}{explicit}\ digit\_grouping(\mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}}\ loc,\ \textcolor{keywordtype}{bool}\ localized\ =\ \textcolor{keyword}{true})\ \{}
...
\DoxyCodeLine{02010\ \ \ \}}
\DoxyCodeLine{02011\ \ \ digit\_grouping(std::string\ grouping,\ std::basic\_string<Char>\ sep)}
...
\DoxyCodeLine{02059\ \ \ \textcolor{keyword}{auto}\ buffer\ =\ memory\_buffer();}
...
\DoxyCodeLine{02067\ \ \ \ \ format\_decimal<char>(appender(buffer),\ value,\ num\_digits);}
...
\DoxyCodeLine{02073\ \ \ \ \ format\_uint<4,\ char>(appender(buffer),\ value,\ num\_digits,\ specs.upper);}
...
\DoxyCodeLine{02081\ \ \ \ \ format\_uint<3,\ char>(appender(buffer),\ value,\ num\_digits);}
...
\DoxyCodeLine{02087\ \ \ \ \ format\_uint<1,\ char>(appender(buffer),\ value,\ num\_digits);}
...
\DoxyCodeLine{02099\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ grouping.apply(it,\ string\_view(\mbox{\hyperlink{classdetail_1_1buffer}{buffer}}.\mbox{\hyperlink{classdetail_1_1buffer_aeb33e0a2d2be2bbca9e0236c148089c8}{data}}(),\ \mbox{\hyperlink{classdetail_1_1buffer}{buffer}}.\mbox{\hyperlink{classdetail_1_1buffer_a8685285932360c284d19003fc4ba3edc}{size}}()));}
\DoxyCodeLine{02100\ \ \ \ \ \ \ \});}
\DoxyCodeLine{02101\ \}}
\DoxyCodeLine{02102\ }
\DoxyCodeLine{02103\ \textcolor{comment}{//\ Writes\ a\ localized\ value.}}
\DoxyCodeLine{02104\ FMT\_API\ \textcolor{keyword}{auto}\ write\_loc(appender\ out,\ loc\_value\ \mbox{\hyperlink{classdetail_1_1value}{value}},\ \textcolor{keyword}{const}\ format\_specs\&\ specs,}
\DoxyCodeLine{02105\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}}\ loc)\ -\/>\ bool;}
\DoxyCodeLine{02106\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ OutputIt>}
\DoxyCodeLine{02107\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ write\_loc(OutputIt,\ loc\_value,\ \textcolor{keyword}{const}\ format\_specs\&,\ \mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}})}
...
\DoxyCodeLine{02208\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structdetail_1_1write__int__arg}{write\_int\_arg<T>}}\ arg,}
\DoxyCodeLine{02209\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ format\_specs\&\ specs,}
...
\DoxyCodeLine{02214\ \ \ \ \ \ \ \ \ \ \ FMT\_ENABLE\_IF(\mbox{\hyperlink{structdetail_1_1is__integral}{is\_integral<T>::value}}\ \&\&}
\DoxyCodeLine{02215\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ !std::is\_same<T,\ bool>::value\ \&\&}
\DoxyCodeLine{02216\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ !std::is\_same<T,\ Char>::value)>}
\DoxyCodeLine{02217\ FMT\_CONSTEXPR\ FMT\_INLINE\ \textcolor{keyword}{auto}\ write(basic\_appender<Char>\ out,\ T\ \mbox{\hyperlink{classdetail_1_1value}{value}},}
\DoxyCodeLine{02218\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ format\_specs\&\ specs,\ \mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}}\ loc)}
\DoxyCodeLine{02219\ \ \ \ \ -\/>\ basic\_appender<Char>\ \{}
\DoxyCodeLine{02220\ \ \ \textcolor{keywordflow}{if}\ (specs.localized\ \&\&\ write\_loc(out,\ \mbox{\hyperlink{classdetail_1_1value}{value}},\ specs,\ loc))\ \textcolor{keywordflow}{return}\ out;}
\DoxyCodeLine{02221\ \ \ \textcolor{keywordflow}{return}\ write\_int\_noinline<Char>(out,\ make\_write\_int\_arg(\mbox{\hyperlink{classdetail_1_1value}{value}},\ specs.sign),}
...
\DoxyCodeLine{02226\ \ \ \ \ \ \ \ \ \ \ FMT\_ENABLE\_IF(\mbox{\hyperlink{structdetail_1_1is__integral}{is\_integral<T>::value}}\ \&\&}
\DoxyCodeLine{02227\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ !std::is\_same<T,\ bool>::value\ \&\&}
\DoxyCodeLine{02228\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ !std::is\_same<T,\ Char>::value\ \&\&}
\DoxyCodeLine{02229\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ !std::is\_same<OutputIt,\ basic\_appender<Char>>::value)>}
\DoxyCodeLine{02230\ FMT\_CONSTEXPR\ FMT\_INLINE\ \textcolor{keyword}{auto}\ write(OutputIt\ out,\ T\ \mbox{\hyperlink{classdetail_1_1value}{value}},}
\DoxyCodeLine{02231\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ format\_specs\&\ specs,\ \mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}}\ loc)}
\DoxyCodeLine{02232\ \ \ \ \ -\/>\ OutputIt\ \{}
\DoxyCodeLine{02233\ \ \ \textcolor{keywordflow}{if}\ (specs.localized\ \&\&\ write\_loc(out,\ \mbox{\hyperlink{classdetail_1_1value}{value}},\ specs,\ loc))\ \textcolor{keywordflow}{return}\ out;}
\DoxyCodeLine{02234\ \ \ \textcolor{keywordflow}{return}\ write\_int<Char>(out,\ make\_write\_int\_arg(\mbox{\hyperlink{classdetail_1_1value}{value}},\ specs.sign),\ specs,}
...
\DoxyCodeLine{02240\ \textcolor{keyword}{class\ }counting\_iterator\ \{}
...
\DoxyCodeLine{02249\ \ \ FMT\_UNCHECKED\_ITERATOR(counting\_iterator);}
\DoxyCodeLine{02250\ }
...
\DoxyCodeLine{02253\ \ \ \};}
\DoxyCodeLine{02254\ }
\DoxyCodeLine{02255\ \ \ FMT\_CONSTEXPR\ counting\_iterator()\ :\ count\_(0)\ \{\}}
\DoxyCodeLine{02256\ }
...
\DoxyCodeLine{02273\ \ \ \}}
\DoxyCodeLine{02274\ }
\DoxyCodeLine{02275\ \ \ FMT\_CONSTEXPR\ \textcolor{keyword}{auto}\ operator*()\ const\ -\/>\ \mbox{\hyperlink{structdetail_1_1counting__iterator_1_1value__type}{value\_type}}\ \{\ \textcolor{keywordflow}{return}\ \{\};\ \}}
\DoxyCodeLine{02276\ \};}
\DoxyCodeLine{02277\ }
\DoxyCodeLine{02278\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Char,\ \textcolor{keyword}{typename}\ OutputIt>}
\DoxyCodeLine{02279\ FMT\_CONSTEXPR\ \textcolor{keyword}{auto}\ write(OutputIt\ out,\ basic\_string\_view<Char>\ s,}
\DoxyCodeLine{02280\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ format\_specs\&\ specs)\ -\/>\ OutputIt\ \{}
...
\DoxyCodeLine{02287\ }
\DoxyCodeLine{02288\ \ \ \textcolor{keywordflow}{if}\ (is\_debug)\ size\ =\ write\_escaped\_string(\mbox{\hyperlink{classdetail_1_1counting__iterator}{counting\_iterator}}\{\},\ s).count();}
\DoxyCodeLine{02289\ }
...
\DoxyCodeLine{02294\ \ \ \ \ \ \ width\ =\ compute\_width(basic\_string\_view<Char>(data,\ size));}
\DoxyCodeLine{02295\ \ \ \}}
...
\DoxyCodeLine{02304\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ basic\_string\_view<type\_identity\_t<Char>>\ s,}
\DoxyCodeLine{02305\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ format\_specs\&\ specs,\ \mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}})\ -\/>\ OutputIt\ \{}
...
\DoxyCodeLine{02309\ FMT\_CONSTEXPR\ \textcolor{keyword}{auto}\ write(OutputIt\ out,\ \textcolor{keyword}{const}\ Char*\ s,\ \textcolor{keyword}{const}\ format\_specs\&\ specs,}
...
\DoxyCodeLine{02314\ \ \ \textcolor{keywordflow}{return}\ write<Char>(out,\ basic\_string\_view<Char>(s),\ specs,\ \{\});}
\DoxyCodeLine{02315\ \}}
\DoxyCodeLine{02316\ }
...
\DoxyCodeLine{02318\ \ \ \ \ \ \ \ \ \ \ FMT\_ENABLE\_IF(\mbox{\hyperlink{structdetail_1_1is__integral}{is\_integral<T>::value}}\ \&\&}
\DoxyCodeLine{02319\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ !std::is\_same<T,\ bool>::value\ \&\&}
\DoxyCodeLine{02320\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ !std::is\_same<T,\ Char>::value)>}
\DoxyCodeLine{02321\ FMT\_CONSTEXPR\ \textcolor{keyword}{auto}\ write(OutputIt\ out,\ T\ \mbox{\hyperlink{classdetail_1_1value}{value}})\ -\/>\ OutputIt\ \{}
\DoxyCodeLine{02322\ \ \ \textcolor{keyword}{auto}\ abs\_value\ =\ \textcolor{keyword}{static\_cast<}uint32\_or\_64\_or\_128\_t<T>\textcolor{keyword}{>}(\mbox{\hyperlink{classdetail_1_1value}{value}});}
\DoxyCodeLine{02323\ \ \ \textcolor{keywordtype}{bool}\ negative\ =\ is\_negative(\mbox{\hyperlink{classdetail_1_1value}{value}});}
...
\DoxyCodeLine{02340\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ format\_specs\&\ specs)\ -\/>\ \textcolor{keyword}{const}\ Char*\ \{}
...
\DoxyCodeLine{02364\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{02365\ \ \ \ \ \ \ \ \ specs.fill\ =\ basic\_string\_view<Char>(begin,\ to\_unsigned(p\ -\/\ begin));}
...
\DoxyCodeLine{02425\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ format\_specs\ specs,\ sign\_t\ sign)}
...
\DoxyCodeLine{02474\ \ \ \}}
\DoxyCodeLine{02475\ \ \ \textcolor{keyword}{auto}\ \mbox{\hyperlink{classdetail_1_1buffer}{buffer}}\ =\ memory\_buffer();}
\DoxyCodeLine{02476\ \ \ write\_significand<char>(appender(\mbox{\hyperlink{classdetail_1_1buffer}{buffer}}),\ significand,\ significand\_size);}
\DoxyCodeLine{02477\ \ \ detail::fill\_n(appender(\mbox{\hyperlink{classdetail_1_1buffer}{buffer}}),\ exponent,\ \textcolor{charliteral}{'0'});}
\DoxyCodeLine{02478\ \ \ \textcolor{keywordflow}{return}\ grouping.apply(out,\ string\_view(\mbox{\hyperlink{classdetail_1_1buffer}{buffer}}.\mbox{\hyperlink{classdetail_1_1buffer_aeb33e0a2d2be2bbca9e0236c148089c8}{data}}(),\ \mbox{\hyperlink{classdetail_1_1buffer}{buffer}}.\mbox{\hyperlink{classdetail_1_1buffer_a8685285932360c284d19003fc4ba3edc}{size}}()));}
\DoxyCodeLine{02479\ \}}
\DoxyCodeLine{02480\ }
...
\DoxyCodeLine{02510\ \ \ Char\ \mbox{\hyperlink{classdetail_1_1buffer}{buffer}}[digits10<UInt>()\ +\ 2];}
\DoxyCodeLine{02511\ \ \ \textcolor{keyword}{auto}\ end\ =\ write\_significand(\mbox{\hyperlink{classdetail_1_1buffer}{buffer}},\ significand,\ significand\_size,}
\DoxyCodeLine{02512\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ integral\_size,\ decimal\_point);}
\DoxyCodeLine{02513\ \ \ \textcolor{keywordflow}{return}\ detail::copy\_noinline<Char>(\mbox{\hyperlink{classdetail_1_1buffer}{buffer}},\ end,\ out);}
\DoxyCodeLine{02514\ \}}
\DoxyCodeLine{02515\ }
...
\DoxyCodeLine{02536\ \ \ \}}
\DoxyCodeLine{02537\ \ \ \textcolor{keyword}{auto}\ \mbox{\hyperlink{classdetail_1_1buffer}{buffer}}\ =\ basic\_memory\_buffer<Char>();}
\DoxyCodeLine{02538\ \ \ write\_significand(basic\_appender<Char>(\mbox{\hyperlink{classdetail_1_1buffer}{buffer}}),\ significand,\ significand\_size,}
\DoxyCodeLine{02539\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ integral\_size,\ decimal\_point);}
\DoxyCodeLine{02540\ \ \ grouping.apply(}
\DoxyCodeLine{02541\ \ \ \ \ \ \ out,\ basic\_string\_view<Char>(\mbox{\hyperlink{classdetail_1_1buffer}{buffer}}.\mbox{\hyperlink{classdetail_1_1buffer_aeb33e0a2d2be2bbca9e0236c148089c8}{data}}(),\ to\_unsigned(integral\_size)));}
\DoxyCodeLine{02542\ \ \ \textcolor{keywordflow}{return}\ detail::copy\_noinline<Char>(\mbox{\hyperlink{classdetail_1_1buffer}{buffer}}.\mbox{\hyperlink{classdetail_1_1buffer_aeb33e0a2d2be2bbca9e0236c148089c8}{data}}()\ +\ integral\_size,}
\DoxyCodeLine{02543\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classdetail_1_1buffer}{buffer}}.end(),\ out);}
\DoxyCodeLine{02544\ \}}
\DoxyCodeLine{02545\ }
...
\DoxyCodeLine{02547\ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{typename}\ Grouping\ =\ \mbox{\hyperlink{classdetail_1_1digit__grouping}{digit\_grouping<Char>}}>}
...
\DoxyCodeLine{02549\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ format\_specs\&\ specs,}
...
\DoxyCodeLine{02651\ \}}
\DoxyCodeLine{02652\ }
\DoxyCodeLine{02653\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Char>\ \textcolor{keyword}{class\ }fallback\_digit\_grouping\ \{}
\DoxyCodeLine{02654\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{02655\ \ \ \textcolor{keyword}{constexpr}\ fallback\_digit\_grouping(\mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}},\ \textcolor{keywordtype}{bool})\ \{\}}
\DoxyCodeLine{02656\ }
...
\DoxyCodeLine{02725\ \}}
\DoxyCodeLine{02726\ }
\DoxyCodeLine{02727\ \textcolor{keyword}{class\ }bigint\ \{}
...
\DoxyCodeLine{02745\ }
\DoxyCodeLine{02746\ \ \ \textcolor{keyword}{friend}\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structformatter}{formatter}}<bigint>;}
\DoxyCodeLine{02747\ }
...
\DoxyCodeLine{02755\ \ \ \ \ \textcolor{keywordtype}{int}\ num\_bigits\ =\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(bigits\_.size())\ -\/\ 1;}
\DoxyCodeLine{02756\ \ \ \ \ \textcolor{keywordflow}{while}\ (num\_bigits\ >\ 0\ \&\&\ (*\textcolor{keyword}{this})[num\_bigits]\ ==\ 0)\ -\/-\/num\_bigits;}
\DoxyCodeLine{02757\ \ \ \ \ bigits\_.resize(to\_unsigned(num\_bigits\ +\ 1));}
\DoxyCodeLine{02758\ \ \ \}}
\DoxyCodeLine{02759\ }
\DoxyCodeLine{02760\ \ \ \textcolor{comment}{//\ Computes\ *this\ -\/=\ other\ assuming\ aligned\ bigints\ and\ *this\ >=\ other.}}
\DoxyCodeLine{02761\ \ \ FMT\_CONSTEXPR20\ \textcolor{keywordtype}{void}\ subtract\_aligned(\textcolor{keyword}{const}\ bigint\&\ other)\ \{}
...
\DoxyCodeLine{02775\ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{size\_t}\ i\ =\ 0,\ n\ =\ bigits\_.size();\ i\ <\ n;\ ++i)\ \{}
...
\DoxyCodeLine{02792\ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{size\_t}\ i\ =\ 0,\ n\ =\ bigits\_.size();\ i\ <\ n;\ ++i)\ \{}
...
\DoxyCodeLine{02812\ \ \ \ \ bigits\_.resize(num\_bigits);}
\DoxyCodeLine{02813\ \ \ \ \ exp\_\ =\ 0;}
\DoxyCodeLine{02814\ \ \ \}}
\DoxyCodeLine{02815\ }
\DoxyCodeLine{02816\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{02817\ \ \ FMT\_CONSTEXPR20\ bigint()\ :\ exp\_(0)\ \{\}}
\DoxyCodeLine{02818\ \ \ \textcolor{keyword}{explicit}\ bigint(uint64\_t\ n)\ \{\ assign(n);\ \}}
\DoxyCodeLine{02819\ }
\DoxyCodeLine{02820\ \ \ bigint(\textcolor{keyword}{const}\ bigint\&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{02821\ \ \ \textcolor{keywordtype}{void}\ operator=(\textcolor{keyword}{const}\ bigint\&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{02822\ }
\DoxyCodeLine{02823\ \ \ FMT\_CONSTEXPR20\ \textcolor{keywordtype}{void}\ assign(\textcolor{keyword}{const}\ bigint\&\ other)\ \{}
...
\DoxyCodeLine{02827\ \ \ \ \ copy<bigit>(data,\ data\ +\ size,\ bigits\_.data());}
...
\DoxyCodeLine{02838\ \ \ \}}
\DoxyCodeLine{02839\ }
\DoxyCodeLine{02840\ \ \ FMT\_NOINLINE\ FMT\_CONSTEXPR20\ \textcolor{keyword}{auto}\ operator<<=(\textcolor{keywordtype}{int}\ shift)\ -\/>\ bigint\&\ \{}
...
\DoxyCodeLine{02856\ \ \ FMT\_CONSTEXPR20\ \textcolor{keyword}{auto}\ operator*=(Int\ \mbox{\hyperlink{classdetail_1_1value}{value}})\ -\/>\ bigint\&\ \{}
...
\DoxyCodeLine{02860\ \ \ \}}
\DoxyCodeLine{02861\ }
\DoxyCodeLine{02862\ \ \ \textcolor{keyword}{friend}\ FMT\_CONSTEXPR20\ \textcolor{keyword}{auto}\ compare(\textcolor{keyword}{const}\ bigint\&\ lhs,\ \textcolor{keyword}{const}\ bigint\&\ rhs)}
...
\DoxyCodeLine{02880\ \ \ \textcolor{keyword}{friend}\ FMT\_CONSTEXPR20\ \textcolor{keyword}{auto}\ add\_compare(\textcolor{keyword}{const}\ bigint\&\ lhs1,}
\DoxyCodeLine{02881\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ bigint\&\ lhs2,\ \textcolor{keyword}{const}\ bigint\&\ rhs)}
...
\DoxyCodeLine{02889\ \ \ \ \ \textcolor{keyword}{auto}\ get\_bigit\ =\ [](\textcolor{keyword}{const}\ bigint\&\ n,\ \textcolor{keywordtype}{int}\ i)\ -\/>\ bigit\ \{}
...
\DoxyCodeLine{02927\ \ \ \ \ \textcolor{keywordtype}{int}\ num\_bigits\ =\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(bigits\_.size());}
...
\DoxyCodeLine{02930\ \ \ \ \ bigits\_.resize(to\_unsigned(num\_result\_bigits));}
...
\DoxyCodeLine{02956\ \ \ FMT\_CONSTEXPR20\ \textcolor{keywordtype}{void}\ align(\textcolor{keyword}{const}\ bigint\&\ other)\ \{}
...
\DoxyCodeLine{02959\ \ \ \ \ \textcolor{keywordtype}{int}\ num\_bigits\ =\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(bigits\_.size());}
\DoxyCodeLine{02960\ \ \ \ \ bigits\_.resize(to\_unsigned(num\_bigits\ +\ exp\_difference));}
...
\DoxyCodeLine{02963\ \ \ \ \ memset(bigits\_.data(),\ 0,\ to\_unsigned(exp\_difference)\ *\ \textcolor{keyword}{sizeof}(bigit));}
...
\DoxyCodeLine{02969\ \ \ FMT\_CONSTEXPR20\ \textcolor{keyword}{auto}\ divmod\_assign(\textcolor{keyword}{const}\ bigint\&\ divisor)\ -\/>\ \textcolor{keywordtype}{int}\ \{}
...
\DoxyCodeLine{03205\ \ \ \}}
\DoxyCodeLine{03206\ \ \ format\_decimal<char>(appender(buf),\ abs\_e,\ detail::count\_digits(abs\_e));}
\DoxyCodeLine{03207\ \}}
\DoxyCodeLine{03208\ }
...
\DoxyCodeLine{03264\ \ \ \ \ \ \ write<char>(appender(buf),\ dec.significand);}
...
\DoxyCodeLine{03268\ \ \ \ \ write<char>(appender(buf),\ dec.significand);}
...
\DoxyCodeLine{03556\ \ \ \}}
\DoxyCodeLine{03557\ }
\DoxyCodeLine{03558\ \ \ memory\_buffer\ buffer;}
...
\DoxyCodeLine{03562\ \ \ \ \ \textcolor{keywordflow}{return}\ write\_bytes<Char,\ align::right>(out,\ \{buffer.data(),\ buffer.size()\},}
...
\DoxyCodeLine{03582\ \ \ \textcolor{keyword}{auto}\ f\ =\ big\_decimal\_fp\{buffer.data(),\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(buffer.size()),\ exp\};}
...
\DoxyCodeLine{03719\ \ \ \textcolor{keyword}{using\ }iterator\ =\ \mbox{\hyperlink{classbasic__appender}{basic\_appender<Char>}};}
\DoxyCodeLine{03720\ \ \ \textcolor{keyword}{using\ }context\ =\ buffered\_context<Char>;}
\DoxyCodeLine{03721\ }
\DoxyCodeLine{03722\ \ \ iterator\ out;}
...
\DoxyCodeLine{03725\ }
\DoxyCodeLine{03726\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>\ \textcolor{keyword}{auto}\ operator()(T\ \mbox{\hyperlink{classdetail_1_1value}{value}})\ -\/>\ iterator\ \{}
\DoxyCodeLine{03727\ \ \ \ \ \textcolor{keywordflow}{return}\ write<Char>(out,\ \mbox{\hyperlink{classdetail_1_1value}{value}});}
\DoxyCodeLine{03728\ \ \ \}}
\DoxyCodeLine{03729\ \ \ \textcolor{keyword}{auto}\ operator()(\textcolor{keyword}{typename}\ \mbox{\hyperlink{classbasic__format__arg_1_1handle}{basic\_format\_arg<context>::handle}}\ h)\ -\/>\ iterator\ \{}
\DoxyCodeLine{03730\ \ \ \ \ \mbox{\hyperlink{classbasic__format__parse__context}{basic\_format\_parse\_context<Char>}}\ parse\_ctx(\{\});}
\DoxyCodeLine{03731\ \ \ \ \ context\ format\_ctx(out,\ args,\ loc);}
...
\DoxyCodeLine{03738\ \ \ \textcolor{keyword}{using\ }iterator\ =\ \mbox{\hyperlink{classbasic__appender}{basic\_appender<Char>}};}
\DoxyCodeLine{03739\ \ \ \textcolor{keyword}{using\ }context\ =\ buffered\_context<Char>;}
\DoxyCodeLine{03740\ }
\DoxyCodeLine{03741\ \ \ iterator\ out;}
...
\DoxyCodeLine{03746\ \ \ FMT\_CONSTEXPR\ FMT\_INLINE\ \textcolor{keyword}{auto}\ operator()(T\ \mbox{\hyperlink{classdetail_1_1value}{value}})\ -\/>\ iterator\ \{}
...
\DoxyCodeLine{03748\ \ \ \}}
\DoxyCodeLine{03749\ \ \ \textcolor{keyword}{auto}\ operator()(\textcolor{keyword}{typename}\ \mbox{\hyperlink{classbasic__format__arg_1_1handle}{basic\_format\_arg<context>::handle}})\ -\/>\ iterator\ \{}
...
\DoxyCodeLine{03854\ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{typename}\ detail::vformat\_args<Char>::type\ args)}
...
\DoxyCodeLine{03864\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ string\_view\ message)\ \textcolor{keyword}{noexcept};}
\DoxyCodeLine{03865\ }
...
\DoxyCodeLine{03872\ FMT\_API\ \textcolor{keyword}{auto}\ vsystem\_error(\textcolor{keywordtype}{int}\ error\_code,\ string\_view\ format\_str,}
\DoxyCodeLine{03873\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ format\_args\ args)\ -\/>\ std::system\_error;}
\DoxyCodeLine{03874\ }
\DoxyCodeLine{03890\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ T>}
\DoxyCodeLine{03891\ \textcolor{keyword}{auto}\ system\_error(\textcolor{keywordtype}{int}\ error\_code,\ format\_string<T...>\ fmt,\ T\&\&...\ args)}
...
\DoxyCodeLine{03915\ }
\DoxyCodeLine{03917\ \textcolor{keyword}{class\ }format\_int\ \{}
...
\DoxyCodeLine{03942\ \ \ \textcolor{keyword}{explicit}\ FMT\_CONSTEXPR20\ format\_int(\textcolor{keywordtype}{int}\ value)\ :\ str\_(format\_signed(value))\ \{\}}
\DoxyCodeLine{03943\ \ \ \textcolor{keyword}{explicit}\ FMT\_CONSTEXPR20\ format\_int(\textcolor{keywordtype}{long}\ value)}
\DoxyCodeLine{03944\ \ \ \ \ \ \ :\ str\_(format\_signed(value))\ \{\}}
\DoxyCodeLine{03945\ \ \ \textcolor{keyword}{explicit}\ FMT\_CONSTEXPR20\ format\_int(\textcolor{keywordtype}{long}\ \textcolor{keywordtype}{long}\ value)}
\DoxyCodeLine{03946\ \ \ \ \ \ \ :\ str\_(format\_signed(value))\ \{\}}
\DoxyCodeLine{03947\ \ \ \textcolor{keyword}{explicit}\ FMT\_CONSTEXPR20\ format\_int(\textcolor{keywordtype}{unsigned}\ value)}
\DoxyCodeLine{03948\ \ \ \ \ \ \ :\ str\_(format\_unsigned(value))\ \{\}}
\DoxyCodeLine{03949\ \ \ \textcolor{keyword}{explicit}\ FMT\_CONSTEXPR20\ format\_int(\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ value)}
\DoxyCodeLine{03950\ \ \ \ \ \ \ :\ str\_(format\_unsigned(value))\ \{\}}
\DoxyCodeLine{03951\ \ \ \textcolor{keyword}{explicit}\ FMT\_CONSTEXPR20\ format\_int(\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ \textcolor{keywordtype}{long}\ value)}
...
\DoxyCodeLine{03975\ \textcolor{keyword}{struct\ }formatter<T,\ Char,\ enable\_if\_t<\mbox{\hyperlink{namespacedetail}{detail}}::has\_format\_as<T>::value>>}
\DoxyCodeLine{03976\ \ \ \ \ :\ formatter<detail::format\_as\_t<T>,\ Char>\ \{}
...
\DoxyCodeLine{03980\ \ \ \ \ \textcolor{keywordflow}{return}\ formatter<detail::format\_as\_t<T>,\ Char>::format(val,\ ctx);}
\DoxyCodeLine{03981\ \ \ \}}
\DoxyCodeLine{03982\ \};}
\DoxyCodeLine{03983\ }
...
\DoxyCodeLine{04005\ \textcolor{keyword}{class\ }formatter<std::basic\_string<Char,\ Traits,\ Allocator>,\ Char>}
\DoxyCodeLine{04006\ \ \ \ \ :\ \textcolor{keyword}{public}\ formatter<basic\_string\_view<Char>,\ Char>\ \{\};}
\DoxyCodeLine{04007\ }
\DoxyCodeLine{04008\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Char,\ \textcolor{keywordtype}{size\_t}\ N>}
\DoxyCodeLine{04009\ \textcolor{keyword}{struct\ }formatter<Char[N],\ Char>\ :\ formatter<basic\_string\_view<Char>,\ Char>\ \{\};}
\DoxyCodeLine{04010\ }
...
\DoxyCodeLine{04042\ }
\DoxyCodeLine{04043\ \textcolor{keyword}{class\ }bytes\ \{}
\DoxyCodeLine{04044\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{04045\ \ \ string\_view\ data\_;}
\DoxyCodeLine{04046\ \ \ \textcolor{keyword}{friend}\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structformatter}{formatter}}<bytes>;}
\DoxyCodeLine{04047\ }
\DoxyCodeLine{04048\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{04049\ \ \ \textcolor{keyword}{explicit}\ bytes(string\_view\ data)\ :\ data\_(data)\ \{\}}
\DoxyCodeLine{04050\ \};}
\DoxyCodeLine{04051\ }
\DoxyCodeLine{04052\ \textcolor{keyword}{template}\ <>\ \textcolor{keyword}{struct\ }formatter<\mbox{\hyperlink{classbytes}{bytes}}>\ \{}
...
\DoxyCodeLine{04090\ \}}
\DoxyCodeLine{04091\ }
\DoxyCodeLine{04092\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>\ \textcolor{keyword}{struct\ }formatter<\mbox{\hyperlink{structgroup__digits__view}{group\_digits\_view}}<T>>\ :\ formatter<T>\ \{}
...
\DoxyCodeLine{04124\ \textcolor{keyword}{struct\ }formatter<\mbox{\hyperlink{structnested__view}{nested\_view}}<T,\ Char>,\ Char>\ \{}
...
\DoxyCodeLine{04134\ \};}
\DoxyCodeLine{04135\ }
\DoxyCodeLine{04136\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T,\ \textcolor{keyword}{typename}\ Char\ =\ \textcolor{keywordtype}{char}>\ \textcolor{keyword}{struct\ }nested\_formatter\ \{}
...
\DoxyCodeLine{04144\ \ \ \textcolor{keyword}{constexpr}\ nested\_formatter()\ :\ width\_(0),\ align\_(align\_t::none)\ \{\}}
\DoxyCodeLine{04145\ }
...
\DoxyCodeLine{04186\ \ \ \textcolor{keyword}{auto}\ buffer\ =\ memory\_buffer();}
\DoxyCodeLine{04187\ \ \ detail::write<char>(appender(buffer),\ value);}
...
\DoxyCodeLine{04220\ \textcolor{keywordtype}{void}\ vformat\_to(\mbox{\hyperlink{classdetail_1_1buffer}{buffer<Char>}}\&\ buf,\ basic\_string\_view<Char>\ fmt,}
\DoxyCodeLine{04221\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{typename}\ vformat\_args<Char>::type\ args,\ \mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}}\ loc)\ \{}
\DoxyCodeLine{04222\ \ \ \textcolor{keyword}{auto}\ out\ =\ basic\_appender<Char>(buf);}
...
\DoxyCodeLine{04226\ \ \ \ \ arg.visit(\mbox{\hyperlink{structdetail_1_1default__arg__formatter}{default\_arg\_formatter<Char>}}\{out,\ args,\ loc\});}
\DoxyCodeLine{04227\ \ \ \ \ \textcolor{keywordflow}{return};}
\DoxyCodeLine{04228\ \ \ \}}
\DoxyCodeLine{04229\ }
\DoxyCodeLine{04230\ \ \ \textcolor{keyword}{struct\ }format\_handler\ \{}
\DoxyCodeLine{04231\ \ \ \ \ basic\_format\_parse\_context<Char>\ parse\_context;}
\DoxyCodeLine{04232\ \ \ \ \ buffered\_context<Char>\ context;}
\DoxyCodeLine{04233\ }
\DoxyCodeLine{04234\ \ \ \ \ format\_handler(basic\_appender<Char>\ p\_out,\ basic\_string\_view<Char>\ str,}
\DoxyCodeLine{04235\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ basic\_format\_args<buffered\_context<Char>>\ p\_args,}
\DoxyCodeLine{04236\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ locale\_ref\ p\_loc)}
\DoxyCodeLine{04237\ \ \ \ \ \ \ \ \ :\ parse\_context(str),\ context(p\_out,\ p\_args,\ p\_loc)\ \{\}}
\DoxyCodeLine{04238\ }
\DoxyCodeLine{04239\ \ \ \ \ \textcolor{keywordtype}{void}\ on\_text(\textcolor{keyword}{const}\ Char*\ begin,\ \textcolor{keyword}{const}\ Char*\ end)\ \{}
\DoxyCodeLine{04240\ \ \ \ \ \ \ \textcolor{keyword}{auto}\ text\ =\ basic\_string\_view<Char>(begin,\ to\_unsigned(end\ -\/\ begin));}
\DoxyCodeLine{04241\ \ \ \ \ \ \ context.advance\_to(write<Char>(context.out(),\ text));}
\DoxyCodeLine{04242\ \ \ \ \ \}}
\DoxyCodeLine{04243\ }
...
\DoxyCodeLine{04250\ \ \ \ \ \}}
\DoxyCodeLine{04251\ \ \ \ \ FMT\_CONSTEXPR\ \textcolor{keyword}{auto}\ on\_arg\_id(basic\_string\_view<Char>\ \textcolor{keywordtype}{id})\ -\/>\ \textcolor{keywordtype}{int}\ \{}
...
\DoxyCodeLine{04253\ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ arg\_id\ =\ context.arg\_id(\textcolor{keywordtype}{id});}
...
\DoxyCodeLine{04259\ \ \ \ \ \ \ \textcolor{keyword}{auto}\ arg\ =\ get\_arg(context,\ \textcolor{keywordtype}{id});}
\DoxyCodeLine{04260\ \ \ \ \ \ \ context.advance\_to(arg.visit(default\_arg\_formatter<Char>\{}
...
\DoxyCodeLine{04266\ \ \ \ \ \ \ \textcolor{keyword}{auto}\ arg\ =\ get\_arg(context,\ \textcolor{keywordtype}{id});}
\DoxyCodeLine{04267\ \ \ \ \ \ \ \textcolor{comment}{//\ Not\ using\ a\ visitor\ for\ custom\ types\ gives\ better\ codegen.}}
\DoxyCodeLine{04268\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (arg.format\_custom(begin,\ parse\_context,\ context))}
...
\DoxyCodeLine{04270\ \ \ \ \ \ \ \textcolor{keyword}{auto}\ specs\ =\ detail::dynamic\_format\_specs<Char>();}
...
\DoxyCodeLine{04273\ \ \ \ \ \ \ \ \ \ \ specs.width,\ specs.width\_ref,\ context);}
\DoxyCodeLine{04274\ \ \ \ \ \ \ detail::handle\_dynamic\_spec<detail::precision\_checker>(}
\DoxyCodeLine{04275\ \ \ \ \ \ \ \ \ \ \ specs.precision,\ specs.precision\_ref,\ context);}
...
\DoxyCodeLine{04278\ \ \ \ \ \ \ context.advance\_to(arg.visit(}
...
\DoxyCodeLine{04291\ \textcolor{keyword}{extern}\ \textcolor{keyword}{template}\ FMT\_API\ \textcolor{keywordtype}{void}\ vformat\_to(\mbox{\hyperlink{classdetail_1_1buffer}{buffer<char>}}\&,\ string\_view,}
\DoxyCodeLine{04292\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{typename}\ vformat\_args<>::type,}
\DoxyCodeLine{04293\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}});}
\DoxyCodeLine{04294\ \textcolor{keyword}{extern}\ \textcolor{keyword}{template}\ FMT\_API\ \textcolor{keyword}{auto}\ thousands\_sep\_impl<char>(\mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}})}
\DoxyCodeLine{04295\ \ \ \ \ -\/>\ \mbox{\hyperlink{structdetail_1_1thousands__sep__result}{thousands\_sep\_result<char>}};}
\DoxyCodeLine{04296\ \textcolor{keyword}{extern}\ \textcolor{keyword}{template}\ FMT\_API\ \textcolor{keyword}{auto}\ thousands\_sep\_impl<wchar\_t>(\mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}})}
\DoxyCodeLine{04297\ \ \ \ \ -\/>\ \mbox{\hyperlink{structdetail_1_1thousands__sep__result}{thousands\_sep\_result<wchar\_t>}};}
\DoxyCodeLine{04298\ \textcolor{keyword}{extern}\ \textcolor{keyword}{template}\ FMT\_API\ \textcolor{keyword}{auto}\ decimal\_point\_impl(\mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}})\ -\/>\ char;}
\DoxyCodeLine{04299\ \textcolor{keyword}{extern}\ \textcolor{keyword}{template}\ FMT\_API\ \textcolor{keyword}{auto}\ decimal\_point\_impl(\mbox{\hyperlink{classdetail_1_1locale__ref}{locale\_ref}})\ -\/>\ wchar\_t;}
...
\DoxyCodeLine{04324\ \textcolor{keyword}{struct\ }formatter<detail::float128,\ Char>}
...
\DoxyCodeLine{04350\ }
\DoxyCodeLine{04351\ FMT\_API\ \textcolor{keyword}{auto}\ vformat(string\_view\ fmt,\ format\_args\ args)\ -\/>\ std::string;}
\DoxyCodeLine{04352\ }
\DoxyCodeLine{04362\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ T>}
\DoxyCodeLine{04363\ FMT\_NODISCARD\ FMT\_INLINE\ \textcolor{keyword}{auto}\ format(format\_string<T...>\ fmt,\ T\&\&...\ args)}
...
\DoxyCodeLine{04369\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ vformat(\textcolor{keyword}{const}\ Locale\&\ loc,\ string\_view\ fmt,\ format\_args\ args)}
...
\DoxyCodeLine{04376\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ format(\textcolor{keyword}{const}\ Locale\&\ loc,\ format\_string<T...>\ fmt,\ T\&\&...\ args)}
\DoxyCodeLine{04377\ \ \ \ \ -\/>\ std::string\ \{}
\DoxyCodeLine{04378\ \ \ \textcolor{keywordflow}{return}\ fmt::vformat(loc,\ string\_view(fmt),\ fmt::make\_format\_args(args...));}
\DoxyCodeLine{04379\ \}}
\DoxyCodeLine{04380\ }
...
\DoxyCodeLine{04384\ \textcolor{keyword}{auto}\ vformat\_to(OutputIt\ out,\ \textcolor{keyword}{const}\ Locale\&\ loc,\ string\_view\ fmt,}
\DoxyCodeLine{04385\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ format\_args\ args)\ -\/>\ OutputIt\ \{}
...
\DoxyCodeLine{04396\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ format\_string<T...>\ fmt,\ T\&\&...\ args)\ -\/>\ OutputIt\ \{}
...
\DoxyCodeLine{04403\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ format\_string<T...>\ fmt,}
